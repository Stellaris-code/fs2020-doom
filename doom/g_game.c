...
void G_DoLoadGame (void) 
{
    ...
    prefixed_name[0] = '\0';
    strcat(prefixed_name, "\\work\\");
    strcat(prefixed_name, savename);
    save_stream = fopen(prefixed_name, "rb");
...
{ 
    ...
    prefixed_name[0] = '\0';
    strcat(prefixed_name, "\\work\\");
    strcat(prefixed_name, temp_savegame_file);
    save_stream = fopen(prefixed_name, "wb");
    ...
    if (save_stream == NULL)
    {
        ...
        prefixed_name[0] = '\0';
        strcat(prefixed_name, "\\work\\");
        strcat(prefixed_name, recovery_savegame_file);
    ...
    static char prefixed_tmp_name[256];
    prefixed_tmp_name[0] = '\0';
    strcat(prefixed_tmp_name, "\\work\\");
    strcat(prefixed_tmp_name, temp_savegame_file);

    prefixed_name[0] = '\0';
    strcat(prefixed_name, "\\work\\");
    strcat(prefixed_name, savegame_file);

    fprintf(stderr, "Renaming from %s to %s\n", prefixed_tmp_name, prefixed_name);
    remove(prefixed_name);
    rename(prefixed_tmp_name, prefixed_name);
