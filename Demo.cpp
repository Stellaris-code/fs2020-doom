...
// Based on the NanoVG sample https://github.com/memononen/nanovg/blob/master/example/demo.c
// See original license at $(MSFS_SDK)\Licenses\LICENSE-NanoVG.txt
...
std::map < FsContext, NVGcontext*> g_DemoNVGcontext;
...
extern "C" {
	...
	MSFS_CALLBACK bool Demo_gauge_callback(FsContext ctx, int service_id, void* pData)
	{
		...
		case PANEL_SERVICE_POST_INSTALL:
		{
			...
			g_DemoNVGcontext[ctx] = nvgCreateInternal(&params);
			NVGcontext* nvgctx = g_DemoNVGcontext[ctx];
